...
// 1.1. Add a 2nd layer group for the tectonic plate data. 2.1 Add a third layer for Major Earthquake Data.
let allEarthquakes = new L.LayerGroup();
let tectonicPlates = new L.LayerGroup();
let majorEarthquakes = new L.LayerGroup();

// 1.2. Add a reference to the tectonic plates group to the overlays object. 2.2 Add ref for major earthquakes.
let overlays = {
